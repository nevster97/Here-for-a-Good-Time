 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
      ...
      <<<<<<< rebecca
                  ...
                  Person4 p4 = new Person4("Rebecca Robbins");
                  toPrint += p4.toString("rrobbins3");
      >>>>>>> master
 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  //Person1 replace P1 with your name
		  //and gburdell1 with your gt id
		  Person1 p1 = new Person1("Isaac");
		  toPrint += p1.toString("idismukes3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kory");
		  toPrint += p2.toString("kbrantley8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nevi");
		  toPrint += p3.toString("nshah344");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Rebecca");
                  toPrint += p4.toString("rrobbins3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yasmin");
                  toPrint += p5.toString("ymartins3");
